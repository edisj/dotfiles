...
if not ok then
    error("failed to load matugen colors", 0)
end
...
vim.g.colors_name = "materialyou"

vim.keymap.set("n", "<C-Enter>", "<CMD>colorscheme matugen<CR>")
local bg = utils.brighten(c.background, 0.03, 0.01)
...
local editor = {
    ...
    WinBarError    = { fg = c.on_error,             bg = c.error,             bold = true },
    WinBarWarn    = { fg = c.on_yellow,             bg = c.yellow,             bold = true },
    WinBarInfo    = { fg = c.on_blue,             bg = c.blue,             bold = true },
    WinBarHint    = { fg = c.on_blue,             bg = c.blue,             bold = true },
