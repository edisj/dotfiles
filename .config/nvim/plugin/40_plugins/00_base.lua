...

  {
    ...
    data = {
      ...
      loader = Config.on_event("BufReadPost", function(name)
        ...
        map("nox", "b", function() require("flash").jump() end)
        map("niox", "<C-space>", function() require("flash").jump() end)
        -- map("nox", "<leader>s", function() require("flash").jump() end)
        map("o", "B", function() require("flash").remote() end)
        map("c", "<C-s>", function() require("flash").jump() end)
